...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "PrimusLearningSeries-VPC2"
  }
}
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name = "PrimusLearning-Public-Subnet2"
  }
}
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name = "PrimusLearning-Private-Subnet2"
  }
}
...
resource "aws_route_table" "public_route_table" {
  vpc_id = aws_vpc.main.id
  tags = {
    Name = "PrimusLearning-Public-RT2"
  }
...
resource "aws_route_table" "private_route_table" {
  vpc_id = aws_vpc.main.id
  tags = {
    Name = "PrimusLearning-Private-RT2"
  }
}
...
resource "aws_instance" "web_public" {
  ...
  tags = {
    Name = "PrimusLearning-Public-Instance2"
  }
}
...
resource "aws_instance" "web_private" {
  ...
  key_name               = "primuslearning-Series-Public-EC2-KP"
  tags = {
    Name = "PrimusLearning-Private-Instance2"
  }
}
...
resource "aws_ebs_volume" "private_instance_volume" {
  ...
  size              = 8
  tags = {
    Name = "PrimusLearning-Private-Instance-Volume2"
  }
}
